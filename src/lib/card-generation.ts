...
export type CardMetadata = { locale: string; template: CardImageInput['theme']; kind: CardImageInput['kind'] };
export type CardGenerationJob = { id: string; input: CardImageInput; metadata: CardMetadata };
...
export async function processCardGeneration({ id, input, metadata }: CardGenerationJob, env: CardGenerationEnv) {
